...
const Banner = () => {
   return (
      <section
         id="home"
         className="flex md:flex-row flex-col-reverse items-center bg-primary justify-center gap-10  md:min-h-screen px-10 py-5 banner"
      >
         <div className="text-white w-full md:w-3/5">
            ...
            <div className="space-y-3">
               <h1 className="text-4xl md:text-[40px] font-bold  md:mt-0 mt-3">
                  Hi , I'm{" "}
                  <span className="ml-1 text-secondary uppercase">
                     Mostafizur Rahaman
                  </span>
               </h1>
               <h3 className="text-3xl uppercase font-semibold flex items-center gap-2">
